                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('update.blog') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="blog_category_id" class="form-select" aria-label="Default select example">
                                            <option selected="" value="{{$blog->blog_category_id}}">{{$blog['category']['blog_category']}}</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_title" class="form-control" value="{{$blog->blog_title}}" type="text"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_tags" class="form-control" value="{{$blog->blog_tags}}" type="text" id="example-text-input" data-role="tagsinput">
                                        @error('blog_tags')
                                            <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
